...
class Shortcode
{
	...
	public static function boot()
	{
		...
		static::add('reviews-homepage', 'FeedbackController@homepage');
		static::add('reviews-json', 'FeedbackController@json');
		static::add('reviews-branchpage', 'FeedbackController@branchpage');				
